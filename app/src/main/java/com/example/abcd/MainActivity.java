        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (a == null || b == null || c == null || d == null){
                    Toast.makeText(getApplicationContext(), "Какие-то значения были не заполнены. Внимательно введите все данные, тогда все будет работать)", Toast.LENGTH_SHORT).show();
                }else{
